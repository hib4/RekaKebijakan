...
Persists project state on the server to avoid large transfers between API calls.
"""
...
class ProjectStatus(str, Enum):
    ...
    CREATED = "created"              # Created with files uploaded
...
class ProjectManager:
    ...
    def _get_project_meta_path(cls, project_id: str) -> str:
        """Return the project metadata path."""
    ...
    def save_file_to_project(cls, project_id: str, file_storage, original_filename: str) -> Dict[str, str]:
        """
        Save an uploaded file in the project directory.
