...
export function intakeToDemoCase(intake: ProjectIntake): DemoCase {
  ...
  return {
    ...
    reportSections: [
      { id: "executive", title: "Ringkasan Eksekutif", content: [`Simulasi ${intake.projectName} menunjukkan bahwa kejelasan implementasi, masa transisi, dan kanal klarifikasi menjadi penentu respons stakeholder. Ketika informasi operasional tersedia dalam satu rujukan, percakapan bergeser dari kekhawatiran umum menuju pertanyaan yang lebih konkret tentang tata cara, jadwal, dan dukungan pelaksanaan.`, `Risiko utama bukan hanya resistensi terhadap kebijakan, melainkan ketidakpastian praktis yang muncul ketika kelompok terdampak tidak dapat memverifikasi apa yang berubah, kapan berlaku, dan ke mana harus meminta koreksi.`] },
      { id: "response", title: "Pergeseran Respons Stakeholder", content: [`${groups[0]} dan ${groups[1]} bergerak dari khawatir menuju netral setelah informasi operasional tersedia. Perubahan sikap paling terlihat ketika institusi menjelaskan tahapan, batas waktu, dan kanal pendampingan dengan bahasa yang mudah ditindaklanjuti.`, `${groups[2]} dan ${groups[3]} tetap menuntut indikator keberhasilan yang dapat dipantau. Kelompok ini cenderung mendukung implementasi jika pemerintah menyediakan bukti respons, bukan hanya pernyataan niat.`] },
      { id: "narrative", title: "Risiko Narasi Utama", content: [primaryRisk, "Risiko meningkat ketika informasi pelaksanaan berbeda antarkanal. Ketidaksamaan istilah, tenggat, atau syarat dapat membuat klarifikasi resmi terlambat dipercaya meskipun substansi kebijakan telah diperbaiki.", "Narasi risiko paling cepat menguat saat pengalaman individu dianggap mewakili seluruh pelaksanaan. Karena itu, respons kebijakan perlu menyertakan bukti layanan, contoh kasus terselesaikan, dan mekanisme koreksi yang terlihat." ] },
      { id: "indirect", title: "Dampak Tidak Langsung", content: ["Ketidakpastian dapat meningkatkan beban klarifikasi pelaksana dan menunda kesiapan kelompok terdampak. Jika tidak dikelola, pelaksana garis depan akan menjadi titik tekanan utama karena menerima pertanyaan yang belum dijawab dalam materi resmi.", "Dampak tidak langsung lain adalah turunnya kepercayaan terhadap kanal informasi formal. Ketika stakeholder lebih cepat memperoleh informasi dari percakapan informal, institusi perlu memperpendek waktu pembaruan dan memastikan jawaban konsisten di semua kanal." ] },
      { id: "recommendation", title: "Rekomendasi Kebijakan", content: ["Perjelas tahapan implementasi, masa transisi, kanal pengaduan, serta indikator evaluasi dalam satu rujukan resmi. Rujukan ini sebaiknya memuat pertanyaan umum, batas waktu respons, contoh kasus, dan kontak eskalasi.", "Tetapkan ritme evaluasi berkala dengan metrik sederhana: jumlah aduan masuk, waktu respons median, proporsi kasus selesai, dan jumlah klarifikasi yang diperbarui. Publikasi metrik ini membantu menunjukkan bahwa kebijakan belajar dari pelaksanaan." ] },
      { id: "evidence", title: "Jejak Bukti Simulasi", content: [`Temuan mengacu pada 8 event, 6 kelompok stakeholder, 30 persona sintetis, dan sumber ${intake.policySource}. Event digunakan untuk membaca pergeseran perhatian, bukan untuk mengukur opini publik aktual.`, "Laporan ini bersifat eksploratif dan ditujukan untuk membantu perancang kebijakan mengidentifikasi titik klarifikasi, risiko narasi, dan kebutuhan pendampingan sebelum implementasi diperluas." ] },
    ],
  };
}
